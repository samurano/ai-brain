# AGENTS/CLAUDE Harness — Checklist
...
- [ ] Прочитаны актуальные инструкции агента для текущего пути: локальные `AGENTS.md` и `CLAUDE.md` (если есть override).
...
- [ ] Проверить актуальность корневых `AGENTS.md` и `CLAUDE.md`.
- [ ] Проверить актуальность локальных `AGENTS.md` и `CLAUDE.md`.
