# CLAUDE.md — fitness-online/landing
...
> Этот файл — локальный override для `fitness-online/landing/` и имеет приоритет над `fitness-online/CLAUDE.md` в пределах этой папки.
