...
## CLAUDE Harness v2 (локальный override)

> Этот файл — локальный override для папки `fitness-online/` и имеет приоритет над корневым `CLAUDE.md` внутри проекта.
...
### Приоритет локальных CLAUDE внутри проекта
- Для задач в `fitness-online/landing/` приоритет у `fitness-online/landing/CLAUDE.md`.
